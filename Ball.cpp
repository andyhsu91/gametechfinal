	...
	SoundManager* sm, Score* sc, bool isServer, bool isMultiplayer)
{
    ...
    ballz->setMaterialName("Examples/Tennis");
   	...
   	//ninja animation states: Attack1 Attack2 Attack3 Backflip Block Climb Crouch Death1 Death2 HighJump Idle1 Idle2 Idle3 Jump JumpNoHeight Kick SideKick Spin Stealth Walk
    //ballz->getAnimationState("Attack1")->setEnabled(true);
    //ballz->getAnimationState("Attack1")->setLoop(true); 
